            ...
            >
                ...
                >
                    ...
                    <Card.Footer
                        ...
                        justifyContent="center"
                    >
                        <ACAButton text={"اقرأ المزيد"} weight={"500"} bg={"cyan"} size="sm" icon={<ProductIconMore />} />
                        <ACAButton text={soon ? "احجز الان" : "شراء"} weight={"500"} bg={"tomato"} size="sm" icon={<ProductIconCart />} />
                    </Card.Footer>
                </Box>
            </Card.Root>
        </Box>
